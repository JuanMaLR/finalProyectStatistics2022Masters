...
kbl(tabla_peso, align = "c", caption = "Weight of 35 candies")%>%
  ...
  scroll_box(width = "530px", height = "800px", fixed_thead = T, extra_css = "margin-left: auto; margin-right: auto;")
```
...
knitr::kable(simulated_data_table, align = "c", caption = "Simulated data table")%>%
  kable_styling(position = "center", full_width = F)%>%
  scroll_box(width = "1120px", height = "800px", fixed_thead = T, extra_css = "margin-left: auto; margin-right: auto;")
```
