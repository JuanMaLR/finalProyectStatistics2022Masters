...
floor_2%>%
  ...
  add_header_above(c("Days", "Measurements" = 7), background = "#2E75B5", color = "#FFFFFF")%>%
...
floor_4%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Days", "Measurements" = 7), background = "#C55A11", color = "#FFFFFF")%>%
...
mean_floors <- data.frame(1:5, mean_floor_2, mean_floor_4, mean_floor_2 - mean_floor_4)
...
#Point 1
mean_point_1_floor_2 <- floor_2$pos_1[seq(3, 15, by = 3)]
mean_point_1_floor_4 <- floor_4$pos_1[seq(3, 15, by = 3)]
mean_floors_point_1 <- data.frame(1:5, mean_point_1_floor_2, mean_point_1_floor_4, mean_point_1_floor_2 - mean_point_1_floor_4)
colnames(mean_floors_point_1) = c("#", "2nd floor", "4th floor", "Difference")

mean_floors_point_1%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Measurements (Point 1)" = 4), background = "#548135", color = "#FFFFFF")

#Point 2
mean_point_2_floor_2 <- floor_2$pos_2[seq(3, 15, by = 3)]
mean_point_2_floor_4 <- floor_4$pos_2[seq(3, 15, by = 3)]
mean_floors_point_2 <- data.frame(1:5, mean_point_2_floor_2, mean_point_2_floor_4, mean_point_2_floor_2 - mean_point_2_floor_4)
colnames(mean_floors_point_2) = c("#", "2nd floor", "4th floor", "Difference")

mean_floors_point_2%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Measurements (Point 2)" = 4), background = "#548135", color = "#FFFFFF")

#Point 3
mean_point_3_floor_2 <- floor_2$pos_3[seq(3, 15, by = 3)]
mean_point_3_floor_4 <- floor_4$pos_3[seq(3, 15, by = 3)]
mean_floors_point_3 <- data.frame(1:5, mean_point_3_floor_2, mean_point_3_floor_4, mean_point_3_floor_2 - mean_point_3_floor_4)
colnames(mean_floors_point_3) = c("#", "2nd floor", "4th floor", "Difference")

mean_floors_point_3%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Measurements (Point 3)" = 4), background = "#548135", color = "#FFFFFF")

#Point 4
mean_point_4_floor_2 <- floor_2$pos_4[seq(3, 15, by = 3)]
mean_point_4_floor_4 <- floor_4$pos_4[seq(3, 15, by = 3)]
mean_floors_point_4 <- data.frame(1:5, mean_point_4_floor_2, mean_point_4_floor_4, mean_point_4_floor_2 - mean_point_4_floor_4)
colnames(mean_floors_point_4) = c("#", "2nd floor", "4th floor", "Difference")

mean_floors_point_4%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Measurements (Point 4)" = 4), background = "#548135", color = "#FFFFFF")

#Point 5
mean_point_5_floor_2 <- floor_2$pos_5[seq(3, 15, by = 3)]
mean_point_5_floor_4 <- floor_4$pos_5[seq(3, 15, by = 3)]
mean_floors_point_5 <- data.frame(1:5, mean_point_5_floor_2, mean_point_5_floor_4, mean_point_5_floor_2 - mean_point_5_floor_4)
colnames(mean_floors_point_5) = c("#", "2nd floor", "4th floor", "Difference")

mean_floors_point_5%>%
  kbl(align = "c")%>%
  kable_material(bootstrap_options = c("striped", "hover", "condensed", "responsive"), full_width = F)%>%
  add_header_above(c("Measurements (Point 5)" = 4), background = "#548135", color = "#FFFFFF")
```
